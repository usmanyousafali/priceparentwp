							...
							<div class="form-group col-md-6">
							  <label><?php echo esc_html__('Price type','exertio_theme'); ?></label>
								...
								<select name="project_type" class="form-control general_select project-type" <?php if(fl_framework_get_options('project_cost') == 1){ ?>required data-smk-msg="<?php echo esc_attr__('Please select price type','exertio_theme'); } ?>" >
									...
									<option value="1" <?php if($project_type== 'fixed' || $project_type== 1) {echo 'selected';} ?>><?php echo esc_html__('Fixed','exertio_theme'); ?></option>
								</select>
							</div>
							
							<div class="form-group col-md-6 fixed-field" <?php echo esc_attr($hide); ?> >
							  <label><?php echo esc_html__(' Cost','exertio_theme'); ?></label>
							  <input type="text" class="form-control" name="project_cost" value="<?php echo esc_attr(get_post_meta($pid, '_project_cost', true));?>" <?php if(fl_framework_get_options('project_cost') == 1){ ?>required data-smk-msg="<?php echo esc_attr__('Please provide project cost','exertio_theme'); }?>" <?php echo esc_attr($not_disabled); ?>>
							</div>
							<div class="form-group col-md-6 hourly-field" <?php echo esc_attr($show); ?> >
							  <label><?php echo esc_html__('Per Hour Price','exertio_theme'); ?></label>
							  <input type="text" class="form-control" name="project_cost_hourly" value="<?php echo esc_attr(get_post_meta($pid, '_project_cost', true));?>" <?php if(fl_framework_get_options('project_cost') == 1){ ?>required data-smk-msg="<?php echo esc_attr__('Please provide per hour price','exertio_theme'); }?>" <?php echo esc_attr($disabled); ?>>
							</div>
