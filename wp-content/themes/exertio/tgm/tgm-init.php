...
function exertio_theme_register_required_plugins() {
	...
	$plugins = array(
		 ...
		 array(
			...
			'external_url'       => esc_url( 'https://downloads.wordpress.org/plugin/elementor.3.4.4.zip'
			 ),
			'is_callable'        => '',
		),
		array(
			...
			'force_activation'   => false,
			'force_deactivation' => false,
			'external_url'       => esc_url( 'https://downloads.wordpress.org/plugin/redux-framework.4.3.1.zip'
			 ),
			'is_callable'        => '',
		),
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false, 
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/woocommerce.5.7.1.zip'),
            'is_callable' => '',
        ),
		array(
            ...
            'force_activation' => false, 
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/contact-form-7.5.4.2.zip'), 
            'is_callable' => '',
        ),
		array(
