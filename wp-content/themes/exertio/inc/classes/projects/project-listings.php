                        ...
                        <div class="style-hd">
                        	<?php
								...
								else if($type == 'hourly' || $type == 2)
								{
									...
									$save_text = esc_html__( 'Estimated Hours ', 'exertio_theme' ).$estimated_hours."<br><br>".esc_html__( 'Total: ', 'exertio_theme' ).get_post_meta($project_id, '_project_cost', true)."*".$estimated_hours."= ".fl_price_separator(is_numeric(get_post_meta($project_id, '_project_cost', true))*is_numeric($estimated_hours));
									echo '<small class="protip" data-pt-position="top" data-pt-scheme="black" data-pt-title="'.$save_text.'"><i class="far fa-question-circle"></i></small>';
								}
							 ?>
                        </div>
						...
						<p class="info-in">
							<?php
								...
								else if($type == 'hourly' || $type == 2)
								{
									...
									$save_text = esc_html__( 'Estimated Hours', 'exertio_theme' ).$estimated_hours."<br><br>".esc_html__( 'Total: ', 'exertio_theme' ).get_post_meta($project_id, '_project_cost', true)."*".$estimated_hours."= ".fl_price_separator(is_numeric(get_post_meta($project_id, '_project_cost', true))*is_numeric($estimated_hours));
									echo '<small class="protip" data-pt-position="top" data-pt-scheme="black" data-pt-title="'.esc_attr($save_text).'"><i class="far fa-question-circle"></i></small>';
								}
							 ?>						
						</p>
					  </li>
